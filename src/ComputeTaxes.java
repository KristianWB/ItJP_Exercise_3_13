import java.util.Scanner;iimport java.util.Scanner;
...
public class ComputeTaxes {
    public static void main(String[] args)   {
        ...
        if (status == 0) { // Compute tax for single filers
        ...
        else if (status == 1) { // Compute tax for married filed jointly or qualifying widower
            if (income <= 16700)
                tax = income * 0.10;
            ...
            else if (income <= 343100)
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (164500 - 67900) * 0.25 + (income - 164500) * 0.28;
            else if (income <= 745900)
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (164500 - 67900) * 0.25 + (343100 - 164500) * 0.28 +
                        (income - 343100) * 0.33;
            else
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (164500 - 67900) * 0.25 + (343100 - 164500) * 0.28 +
                        (745900 - 343100) * 0.33 + (income - 745900) * 0.35;
        }
        else if (status == 2) { // Compute tax for married files separatlely
            // Left for excercise 3.13
        }
